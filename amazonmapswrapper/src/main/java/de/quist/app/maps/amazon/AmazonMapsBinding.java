...
public class AmazonMapsBinding implements MapsBinding {
    ...
    private static final de.quist.app.maps.model.Tile NO_TILE = de.quist.app.maps.amazon.Tile.wrap(com.amazon.geo.mapsv2.model.TileProvider.NO_TILE);
    ...
    public de.quist.app.maps.model.CameraPosition cameraPosition(de.quist.app.maps.model.LatLng target, float zoom, float tilt, float bearing) {
        return de.quist.app.maps.amazon.CameraPosition.wrap(new com.amazon.geo.mapsv2.model.CameraPosition(de.quist.app.maps.amazon.LatLng.unwrap(target), zoom, tilt, bearing));
    }
    ...
    public de.quist.app.maps.model.CameraPosition cameraPositionFromLatLngZoom(de.quist.app.maps.model.LatLng target, float zoom) {
        return de.quist.app.maps.amazon.CameraPosition.wrap(com.amazon.geo.mapsv2.model.CameraPosition.fromLatLngZoom(de.quist.app.maps.amazon.LatLng.unwrap(target), zoom));
    }
    ...
    public de.quist.app.maps.model.CircleOptions circleOptions() {
        return de.quist.app.maps.amazon.CircleOptions.wrap(new com.amazon.geo.mapsv2.model.CircleOptions());
    }

    @Override
    public de.quist.app.maps.model.GroundOverlayOptions groundOverlayOptions() {
        return de.quist.app.maps.amazon.GroundOverlayOptions.wrap(new com.amazon.geo.mapsv2.model.GroundOverlayOptions());
    }

    @Override
    public de.quist.app.maps.model.LatLng latLng(double latitude, double longitude) {
        return de.quist.app.maps.amazon.LatLng.wrap(new com.amazon.geo.mapsv2.model.LatLng(latitude, longitude));
    }
    ...
    public de.quist.app.maps.model.LatLngBounds latLngBounds(de.quist.app.maps.model.LatLng southwest, de.quist.app.maps.model.LatLng northeast) {
        return de.quist.app.maps.amazon.LatLngBounds.wrap(new com.amazon.geo.mapsv2.model.LatLngBounds(de.quist.app.maps.amazon.LatLng.unwrap(southwest), de.quist.app.maps.amazon.LatLng.unwrap(northeast)));
    }
    ...
    public de.quist.app.maps.model.MarkerOptions markerOptions() {
        return de.quist.app.maps.amazon.MarkerOptions.wrap(new com.amazon.geo.mapsv2.model.MarkerOptions());
    }

    @Override
    public de.quist.app.maps.model.PolygonOptions polygonOptions() {
        return de.quist.app.maps.amazon.PolygonOptions.wrap(new com.amazon.geo.mapsv2.model.PolygonOptions());
    }

    @Override
    public de.quist.app.maps.model.PolylineOptions polylineOptions() {
        return de.quist.app.maps.amazon.PolylineOptions.wrap(new com.amazon.geo.mapsv2.model.PolylineOptions());
    }

    @Override
    public de.quist.app.maps.model.TileOverlayOptions tileOverlayOptions() {
        return de.quist.app.maps.amazon.TileOverlayOptions.wrap(new com.amazon.geo.mapsv2.model.TileOverlayOptions());
    }

    @Override
    public de.quist.app.maps.model.Tile tile(int width, int height, byte[] data) {
        return de.quist.app.maps.amazon.Tile.wrap(new com.amazon.geo.mapsv2.model.Tile(width, height, data));
    }
    ...
    public de.quist.app.maps.model.VisibleRegion visibleRegion(de.quist.app.maps.model.LatLng nearLeft, de.quist.app.maps.model.LatLng nearRight, de.quist.app.maps.model.LatLng farLeft, de.quist.app.maps.model.LatLng farRight, de.quist.app.maps.model.LatLngBounds latLngBounds) {
        return de.quist.app.maps.amazon.VisibleRegion.wrap(new com.amazon.geo.mapsv2.model.VisibleRegion(de.quist.app.maps.amazon.LatLng.unwrap(nearLeft), de.quist.app.maps.amazon.LatLng.unwrap(nearRight), de.quist.app.maps.amazon.LatLng.unwrap(farLeft), de.quist.app.maps.amazon.LatLng.unwrap(farRight), de.quist.app.maps.amazon.LatLngBounds.unwrap(latLngBounds)));
    }
    ...
    public de.quist.app.maps.MapFragmentWrapper mapFragmentWrapperFrom(Object fragment) {
        if (fragment instanceof com.amazon.geo.mapsv2.SupportMapFragment) {
            return SupportMapFragmentWrapper.wrap((com.amazon.geo.mapsv2.SupportMapFragment) fragment);
        } else if (fragment instanceof com.amazon.geo.mapsv2.MapFragment) {
            return de.quist.app.maps.amazon.MapFragmentWrapper.wrap((com.amazon.geo.mapsv2.MapFragment) fragment);
        }
        return null;
    }
    ...
    public MapViewWrapper mapViewWrapperFrom(View view) {
        if (view instanceof com.amazon.geo.mapsv2.MapView) {
            return MapViewWrapper.wrap((com.amazon.geo.mapsv2.MapView) view);
        }
        return null;
    }
    ...
    public Fragment newMapFragmentInstance(de.quist.app.maps.MapOptions options) {
        return com.amazon.geo.mapsv2.MapFragment.newInstance(MapOptions.unwrap(options));
    }
    ...
    public android.support.v4.app.Fragment newSupportMapFragmentInstance(de.quist.app.maps.MapOptions options) {
        return com.amazon.geo.mapsv2.SupportMapFragment.newInstance(MapOptions.unwrap(options));
    }
    ...
    public de.quist.app.maps.model.TileProvider urlTileProvider(int width, int height, final UrlTileProvider tileProvider) {
        return de.quist.app.maps.amazon.TileProvider.wrap(new com.amazon.geo.mapsv2.model.UrlTileProvider(width, height) {
