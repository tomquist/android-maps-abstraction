...
class VisibleRegion implements de.quist.app.mapsabstraction.model.VisibleRegion {
    ...
    static com.amazon.geo.mapsv2.model.VisibleRegion unwrap(de.quist.app.mapsabstraction.model.VisibleRegion visibleRegion) {
        return visibleRegion != null ? ((VisibleRegion)visibleRegion).original : null;
    }

    static de.quist.app.mapsabstraction.model.VisibleRegion wrap(com.amazon.geo.mapsv2.model.VisibleRegion visibleRegion) {
