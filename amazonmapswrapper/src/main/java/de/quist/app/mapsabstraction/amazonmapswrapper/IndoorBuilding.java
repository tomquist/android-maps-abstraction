...
class IndoorBuilding implements de.quist.app.mapsabstraction.model.IndoorBuilding {
    ...
    static com.amazon.geo.mapsv2.model.IndoorBuilding unwrap(de.quist.app.mapsabstraction.model.IndoorBuilding indoorBuilding) {
        return indoorBuilding != null ? ((IndoorBuilding)indoorBuilding).original : null;
    }

    static de.quist.app.mapsabstraction.model.IndoorBuilding wrap(com.amazon.geo.mapsv2.model.IndoorBuilding indoorBuilding) {
