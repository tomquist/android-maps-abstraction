...
class UiSettings implements de.quist.app.mapsabstraction.UiSettings {
    ...
    static com.amazon.geo.mapsv2.UiSettings unwrap(de.quist.app.mapsabstraction.UiSettings uiSettings) {
        return uiSettings != null ? ((UiSettings)uiSettings).original : null;
    }

    static de.quist.app.mapsabstraction.UiSettings wrap(com.amazon.geo.mapsv2.UiSettings uiSettings) {
