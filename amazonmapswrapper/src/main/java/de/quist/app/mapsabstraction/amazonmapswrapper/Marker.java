...
class Marker implements de.quist.app.mapsabstraction.model.Marker {
    ...
    static com.amazon.geo.mapsv2.model.Marker unwrap(de.quist.app.mapsabstraction.model.Marker marker) {
        return marker != null ? ((Marker)marker).original : null;
    }

    static de.quist.app.mapsabstraction.model.Marker wrap(com.amazon.geo.mapsv2.model.Marker marker) {
