...
class LatLngBounds implements de.quist.app.mapsabstraction.model.LatLngBounds {
    ...
    static com.amazon.geo.mapsv2.model.LatLngBounds unwrap(de.quist.app.mapsabstraction.model.LatLngBounds bounds) {
        return bounds != null ? ((LatLngBounds)bounds).original : null;
    }

    static de.quist.app.mapsabstraction.model.LatLngBounds wrap(com.amazon.geo.mapsv2.model.LatLngBounds bounds) {
