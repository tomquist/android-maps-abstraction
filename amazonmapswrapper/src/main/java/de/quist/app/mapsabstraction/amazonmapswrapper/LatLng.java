...
class LatLng implements de.quist.app.mapsabstraction.model.LatLng {
    ...
    static com.amazon.geo.mapsv2.model.LatLng unwrap(de.quist.app.mapsabstraction.model.LatLng latLng) {
    ...
    static List<com.amazon.geo.mapsv2.model.LatLng> unwrap(List<de.quist.app.mapsabstraction.model.LatLng> points) {
    ...
    static List<de.quist.app.mapsabstraction.model.LatLng> wrap(List<com.amazon.geo.mapsv2.model.LatLng> points) {
