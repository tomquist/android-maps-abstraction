...
class Polyline implements de.quist.app.mapsabstraction.model.Polyline {
    ...
    static com.amazon.geo.mapsv2.model.Polyline unwrap(de.quist.app.mapsabstraction.model.Polyline polyline) {
        return polyline != null ? ((Polyline)polyline).original : null;
    }

    static de.quist.app.mapsabstraction.model.Polyline wrap(com.amazon.geo.mapsv2.model.Polyline polyline) {
