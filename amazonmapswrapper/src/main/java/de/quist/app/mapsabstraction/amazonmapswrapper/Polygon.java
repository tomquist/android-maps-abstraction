...
class Polygon implements de.quist.app.mapsabstraction.model.Polygon {
    ...
    static com.amazon.geo.mapsv2.model.Polygon unwrap(de.quist.app.mapsabstraction.model.Polygon polygon) {
        return polygon != null ? ((Polygon)polygon).original : null;
    }

    static de.quist.app.mapsabstraction.model.Polygon wrap(com.amazon.geo.mapsv2.model.Polygon polygon) {
