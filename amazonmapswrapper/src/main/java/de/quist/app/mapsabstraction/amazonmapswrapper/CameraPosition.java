...
class CameraPosition implements de.quist.app.mapsabstraction.model.CameraPosition {
    ...
    static com.amazon.geo.mapsv2.model.CameraPosition unwrap(de.quist.app.mapsabstraction.model.CameraPosition cameraPosition) {
        return cameraPosition != null ? ((CameraPosition)cameraPosition).original : null;
    }

    static de.quist.app.mapsabstraction.model.CameraPosition wrap(com.amazon.geo.mapsv2.model.CameraPosition cameraPosition) {
