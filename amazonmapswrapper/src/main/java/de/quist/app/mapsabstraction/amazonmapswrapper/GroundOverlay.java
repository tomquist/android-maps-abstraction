...
class GroundOverlay implements de.quist.app.mapsabstraction.model.GroundOverlay {
    ...
    static com.amazon.geo.mapsv2.model.GroundOverlay unwrap(de.quist.app.mapsabstraction.model.GroundOverlay groundOverlay) {
        return groundOverlay != null ? ((GroundOverlay)groundOverlay).original : null;
    }

    static de.quist.app.mapsabstraction.model.GroundOverlay wrap(com.amazon.geo.mapsv2.model.GroundOverlay groundOverlay) {
