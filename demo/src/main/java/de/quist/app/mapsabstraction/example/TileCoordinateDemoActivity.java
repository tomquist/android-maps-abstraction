...
public class TileCoordinateDemoActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(Map map) {
        ...
        map.addTileOverlay(BuildConfig.MAP_IMPLEMENTATION.tileOverlayOptions().tileProvider(coordTileProvider));
    }
    ...
    private static class CoordTileProvider implements TileProvider {
        ...
        public Tile getTile(int x, int y, int zoom) {
            ...
            return BuildConfig.MAP_IMPLEMENTATION.tile((int) (TILE_SIZE_DP * mScaleFactor),
