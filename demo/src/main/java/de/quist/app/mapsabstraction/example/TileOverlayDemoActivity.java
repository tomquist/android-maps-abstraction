...
import de.quist.app.mapsabstraction.model.TileOverlay;
...
public class TileOverlayDemoActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(Map map) {
        ...
        TileProvider tileProvider = BuildConfig.MAP_IMPLEMENTATION.urlTileProvider(256, 256, new UrlTileProvider() {
            @Override
        ...
        mMoonTiles = map.addTileOverlay(BuildConfig.MAP_IMPLEMENTATION.tileOverlayOptions().tileProvider(tileProvider));
    }
