...
import de.quist.app.mapsabstraction.CameraUpdate;
...
public class CameraDemoActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public static final CameraPosition BONDI =
            BuildConfig.MAP_IMPLEMENTATION.cameraPositionBuilder().target(BuildConfig.MAP_IMPLEMENTATION.latLng(-33.891614, 151.276417))
                    .zoom(15.5f)
                    .bearing(300)
                    .tilt(50)
                    .build();
    ...
    public static final CameraPosition SYDNEY =
            BuildConfig.MAP_IMPLEMENTATION.cameraPositionBuilder().target(BuildConfig.MAP_IMPLEMENTATION.latLng(-33.87365, 151.20689))
                    .zoom(15.5f)
                    .bearing(0)
                    .tilt(25)
                    .build();
    ...
    public void onMapReady(Map map) {
        ...
        // Show Sydney
        mMap.moveCamera(BuildConfig.MAP_IMPLEMENTATION.cameraUpdateFactory().newLatLngZoom(BuildConfig.MAP_IMPLEMENTATION.latLng(-33.87365, 151.20689), 10));
    }
    ...
    public void onGoToBondi(View view) {
        ...
        changeCamera(BuildConfig.MAP_IMPLEMENTATION.cameraUpdateFactory().newCameraPosition(BONDI));
    }
    ...
    public void onGoToSydney(View view) {
        ...
        changeCamera(BuildConfig.MAP_IMPLEMENTATION.cameraUpdateFactory().newCameraPosition(SYDNEY), new Map.CancelableCallback() {
            @Override
    ...
    public void onZoomIn(View view) {
        ...
        changeCamera(BuildConfig.MAP_IMPLEMENTATION.cameraUpdateFactory().zoomIn());
    }
    ...
    public void onZoomOut(View view) {
        ...
        changeCamera(BuildConfig.MAP_IMPLEMENTATION.cameraUpdateFactory().zoomOut());
    }
    ...
    public void onTiltMore(View view) {
        ...
        CameraPosition cameraPosition = BuildConfig.MAP_IMPLEMENTATION.cameraPositionBuilder(currentCameraPosition)
                .tilt(newTilt).build();

        changeCamera(BuildConfig.MAP_IMPLEMENTATION.cameraUpdateFactory().newCameraPosition(cameraPosition));
    }
    ...
    public void onScrollLeft(View view) {
        ...
        changeCamera(BuildConfig.MAP_IMPLEMENTATION.cameraUpdateFactory().scrollBy(-SCROLL_BY_PX, 0));
    }
    ...
    public void onScrollUp(View view) {
        ...
        changeCamera(BuildConfig.MAP_IMPLEMENTATION.cameraUpdateFactory().scrollBy(0, -SCROLL_BY_PX));
    }
