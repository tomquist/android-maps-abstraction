...
import de.quist.app.mapsabstraction.model.IndoorBuilding;
import de.quist.app.mapsabstraction.model.IndoorLevel;
...
public class IndoorDemoActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(Map map) {
        mMap = map;
        mMap.moveCamera(BuildConfig.MAP_IMPLEMENTATION.cameraUpdateFactory().newLatLngZoom(BuildConfig.MAP_IMPLEMENTATION.latLng(37.614631, -122.385153), 18));
    }
