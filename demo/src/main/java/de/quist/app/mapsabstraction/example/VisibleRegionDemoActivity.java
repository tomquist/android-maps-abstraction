...
public class VisibleRegionDemoActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private static final LatLng SOH = BuildConfig.MAP_IMPLEMENTATION.latLng(-33.85704, 151.21522);
    private static final LatLng SFO = BuildConfig.MAP_IMPLEMENTATION.latLng(37.614631, -122.385153);
    private static final LatLngBounds AUS = BuildConfig.MAP_IMPLEMENTATION.latLngBounds(
            BuildConfig.MAP_IMPLEMENTATION.latLng(-44, 113), BuildConfig.MAP_IMPLEMENTATION.latLng(-10, 154));
    ...
    public void onMapReady(Map map) {
        ...
        mMap.moveCamera(BuildConfig.MAP_IMPLEMENTATION.cameraUpdateFactory().newLatLngZoom(SFO, 18));
        // Add a marker to the Opera House
        mMap.addMarker(BuildConfig.MAP_IMPLEMENTATION.markerOptions().position(SOH).title("Sydney Opera House"));
    ...
    public void moveToOperaHouse(View view) {
        ...
        mMap.moveCamera(BuildConfig.MAP_IMPLEMENTATION.cameraUpdateFactory().newLatLngZoom(SOH, 16));
    }
    ...
    public void moveToAUS(View view) {
        ...
        mMap.moveCamera(BuildConfig.MAP_IMPLEMENTATION.cameraUpdateFactory().newLatLngBounds(AUS, 0));
    }
    ...
    public void setMorePadding(View view) {
        ...
        View mapView = BuildConfig.MAP_IMPLEMENTATION.mapFragmentFrom(
