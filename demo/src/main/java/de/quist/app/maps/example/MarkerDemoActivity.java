...
import de.quist.app.maps.Map.InfoWindowAdapter;
...
public class MarkerDemoActivity extends FragmentActivity implements
        ...
        if (mapView.getViewTreeObserver().isAlive()) {
            mapView.getViewTreeObserver().addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
                ...
                public void onGlobalLayout() {
                    LatLngBounds bounds = BuildConfig.MAP_BINDING.latLngBoundsBuilder()
                            .include(PERTH)
                            .include(SYDNEY)
                            .include(ADELAIDE)
                            .include(BRISBANE)
                    ...
                    mMap.moveCamera(BuildConfig.MAP_BINDING.cameraUpdateFactory().newLatLngBounds(bounds, 50));
                }
            });
        }
    }
    ...
    private void addMarkersToMap() {
        ...
        mSydney = mMap.addMarker(BuildConfig.MAP_BINDING.markerOptions()
                ...
                .icon(BuildConfig.MAP_BINDING.bitmapDescriptorFactory().fromResource(R.drawable.arrow))
        ...
        for (int i = 0; i < numMarkersInRainbow; i++) {
            mMarkerRainbow.add(mMap.addMarker(BuildConfig.MAP_BINDING.markerOptions()
                    ...
                    .title("Marker " + i)
                    .icon(BuildConfig.MAP_BINDING.bitmapDescriptorFactory().defaultMarker(i * 360 / numMarkersInRainbow))
                    .flat(flat)
                    .rotation(rotation)));
        }
    }
    ...
    public boolean onMarkerClick(final Marker marker) {
        if (marker.equals(mPerth)) {
            ...
            marker.setIcon(BuildConfig.MAP_BINDING.bitmapDescriptorFactory().defaultMarker(mRandom.nextFloat() * 360));
