...
import de.quist.app.maps.model.BitmapDescriptor;
...
public class GroundOverlayDemoActivity extends FragmentActivity
    ...
    public void onMapReady(Map map) {
        map.moveCamera(BuildConfig.MAP_BINDING.cameraUpdateFactory().newLatLngZoom(NEWARK, 11));

        mImages.clear();
        mImages.add(BuildConfig.MAP_BINDING.bitmapDescriptorFactory().fromResource(R.drawable.newark_nj_1922));
