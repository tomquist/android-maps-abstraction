...
class Marker implements de.quist.app.mapsabstraction.model.Marker {

    static com.google.android.gms.maps.model.Marker unwrap(de.quist.app.mapsabstraction.model.Marker marker) {
        return marker != null ? ((Marker)marker).original : null;
    }

    static de.quist.app.mapsabstraction.model.Marker wrap(com.google.android.gms.maps.model.Marker marker) {
    ...
    @Override
    public void setIcon(de.quist.app.mapsabstraction.model.BitmapDescriptor icon) {
