...
class LatLng implements de.quist.app.mapsabstraction.model.LatLng {

    static com.google.android.gms.maps.model.LatLng unwrap(de.quist.app.mapsabstraction.model.LatLng latLng) {
    ...
    static List<com.google.android.gms.maps.model.LatLng> unwrap(List<de.quist.app.mapsabstraction.model.LatLng> points) {
        List<com.google.android.gms.maps.model.LatLng> unwrappedPoints = new ArrayList<>(points.size());
        for (de.quist.app.mapsabstraction.model.LatLng point : points) {
            unwrappedPoints.add(LatLng.unwrap(point));
        }
        return unwrappedPoints;
    }

    static List<de.quist.app.mapsabstraction.model.LatLng> wrap(List<com.google.android.gms.maps.model.LatLng> points) {
        List<de.quist.app.mapsabstraction.model.LatLng> wrappedPoints = new ArrayList<>(points.size());
