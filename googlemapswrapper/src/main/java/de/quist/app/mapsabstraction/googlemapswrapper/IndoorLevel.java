...
class IndoorLevel implements de.quist.app.mapsabstraction.model.IndoorLevel {
    ...
    static com.google.android.gms.maps.model.IndoorLevel unwrap(de.quist.app.mapsabstraction.model.IndoorLevel indoorLevel) {
        return indoorLevel != null ? ((IndoorLevel)indoorLevel).original : null;
    }

    static de.quist.app.mapsabstraction.model.IndoorLevel wrap(com.google.android.gms.maps.model.IndoorLevel indoorLevel) {
