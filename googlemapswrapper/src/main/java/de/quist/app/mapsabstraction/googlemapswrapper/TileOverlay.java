...
class TileOverlay implements de.quist.app.mapsabstraction.model.TileOverlay {
    ...
    static com.google.android.gms.maps.model.TileOverlay unwrap(de.quist.app.mapsabstraction.model.TileOverlay tileOverlay) {
        return tileOverlay != null ? ((TileOverlay)tileOverlay).original : null;
    }

    static de.quist.app.mapsabstraction.model.TileOverlay wrap(com.google.android.gms.maps.model.TileOverlay tileOverlay) {
