...
class Circle implements de.quist.app.mapsabstraction.model.Circle {
    ...
    static com.google.android.gms.maps.model.Circle unwrap(de.quist.app.mapsabstraction.model.Circle circle) {
        return circle != null ? ((Circle)circle).original : null;
    }

    static de.quist.app.mapsabstraction.model.Circle wrap(com.google.android.gms.maps.model.Circle circle) {
