...
class IndoorBuilding implements de.quist.app.mapsabstraction.model.IndoorBuilding {

    static com.google.android.gms.maps.model.IndoorBuilding unwrap(de.quist.app.mapsabstraction.model.IndoorBuilding indoorBuilding) {
        return indoorBuilding != null ? ((IndoorBuilding)indoorBuilding).original : null;
    }

    static de.quist.app.mapsabstraction.model.IndoorBuilding wrap(com.google.android.gms.maps.model.IndoorBuilding indoorBuilding) {
    ...
    @Override
    public List<de.quist.app.mapsabstraction.model.IndoorLevel> getLevels() {
        List<com.google.android.gms.maps.model.IndoorLevel> unwrappedLevels = original.getLevels();
        List<de.quist.app.mapsabstraction.model.IndoorLevel> wrappedLevels = new ArrayList<>(unwrappedLevels.size());
