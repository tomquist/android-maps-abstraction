...
class UiSettings implements de.quist.app.mapsabstraction.UiSettings {

    static com.google.android.gms.maps.UiSettings unwrap(de.quist.app.mapsabstraction.UiSettings uiSettings) {
        return uiSettings != null ? ((UiSettings)uiSettings).original : null;
    }

    static de.quist.app.mapsabstraction.UiSettings wrap(com.google.android.gms.maps.UiSettings uiSettings) {
