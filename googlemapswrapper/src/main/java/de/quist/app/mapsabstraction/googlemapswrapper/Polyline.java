...
class Polyline implements de.quist.app.mapsabstraction.model.Polyline {

    static com.google.android.gms.maps.model.Polyline unwrap(de.quist.app.mapsabstraction.model.Polyline polyline) {
        return polyline != null ? ((Polyline)polyline).original : null;
    }

    static de.quist.app.mapsabstraction.model.Polyline wrap(com.google.android.gms.maps.model.Polyline polyline) {
        return polyline != null ? new Polyline(polyline) : null;
    }

    final com.google.android.gms.maps.model.Polyline original;
