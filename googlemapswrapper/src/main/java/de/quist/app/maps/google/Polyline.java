...
class Polyline implements de.quist.app.maps.model.Polyline {
    ...
    static com.google.android.gms.maps.model.Polyline unwrap(de.quist.app.maps.model.Polyline polyline) {
        return polyline != null ? ((Polyline)polyline).original : null;
    }

    static de.quist.app.maps.model.Polyline wrap(com.google.android.gms.maps.model.Polyline polyline) {
